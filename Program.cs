...
do
{
    try
    {
        ...
        //Iforme qual alteraçãoo ele realizou
       // string resultado = calculaIMC.Calcular(peso, altura);
        Console.WriteLine(calculaIMC.Calcular(peso, altura));
        //Crie uma classe chamada Calculadora, que possua um método que some dois números inteiros e retorne o resultado dessa soma. O nome desse método deve ser Soma. 
        //Ao final deverão ser exibidos os números informados e o valor da soma
